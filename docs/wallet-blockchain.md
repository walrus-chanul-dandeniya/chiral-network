...
- **Power Usage**: Real power consumption (when available) or estimated power consumption
- **Efficiency**: Hash/watt ratio (based on real or estimated power consumption)
